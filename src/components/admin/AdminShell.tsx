...
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  const nav: NavItem[] = [
    ...
    { href: "/admin/domains", label: "Domains", icon: Globe, show: true },
    {
      ...
      label: "Appostta",
      icon: Stamp,
      show: isSuper || can("appostta_create") || can("appostta_edit") || can("appostta_delete") || can("appostta_settings"),
    },
    { href: "/admin/storage", label: "Storage", icon: HardDrive, show: isSuper },
